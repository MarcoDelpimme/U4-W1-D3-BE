      ...
      <thead>
        <tr>
         ...
         foreach ($stmt as $row)
         {
            ...
            echo "<td>{$row['age']}</td>"; 
            echo "<td id='btn-td'>
            <a href='http://localhost/U4-W1-D3-BE/delete.php?id={$row['id']}'><button class='btn btn-danger'>delete</button></a>
            <a href='http://localhost/U4-W1-D3-BE/details.php?id={$row['id']}'><button class='btn btn-info'>details</button></a>
            <a href='http://localhost/U4-W1-D3-BE/modify.php?id={$row['id']}'><button class='btn btn-warning'>modify</button></a>
            </td>";
